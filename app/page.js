        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16, marginBottom: 60 }}>
            {[
              ...
              { tag: 'Conversation · Media Literacy · Live', name: 'Consider Otherwise: Life Conversations', desc: 'A live conversation show. Guests, callers, and a standing invitation: bring me your argument. When someone makes a claim we can check, we stop and check it on air with RhetoricalPoints, run the same way for my claims as for theirs.', href: null, nextLabel: 'GroundedVote', nextHref: 'https://groundedvote.com', status: 'Live', delay: 240 },
            ].map(node => (
              <Reveal key={node.name} delay={node.delay}>
                <NodeCard {...node} dark />
              </Reveal>
